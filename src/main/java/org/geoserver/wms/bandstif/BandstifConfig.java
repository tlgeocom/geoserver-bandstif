...
/**
 * Constants used for configuration of bandstif data layers.
 *
 * @author Parker Abercrombie
 */
public interface BandstifConfig {

    /**
     * Metadata key for the default data type to return (e.g. "application/bil16") if a request does
     * not specify a data type.
     */
    public static final String DEFAULT_DATA_TYPE = "bandstif.defaultDataTypeAttribute";

    /** Metadata key for the byte order of BIL response data. */
    public static final String BYTE_ORDER = "bandstif.byteOrderAttribute";
     ...
     */
    public static final String NO_DATA_OUTPUT = "bandstif.noDataOutputAttribute";
}
