 ...
 * @since 2.0.x
 */
public class BandstifTest extends WMSTestSupport {
    ...
    protected void onSetUp(SystemTestData testData) throws Exception {
        ...
        testData.addStyle("raster", "raster.sld", BandstifTest.class, catalog);
        testData.addRasterLayer(AUS_DEM, "aus_dem.tiff", "tiff", null, BandstifTest.class, catalog);
        testData.addRasterLayer(SF_DEM, "sfdem.tiff", "tiff", null, BandstifTest.class, catalog);
    ...
    public void testDefaultDataType() throws Exception {
        // Int8 default type
        setConfiguration(AUS_DEM, BandstifConfig.DEFAULT_DATA_TYPE, "application/bil8");
        ...
        // Int16 default type
        setConfiguration(AUS_DEM, BandstifConfig.DEFAULT_DATA_TYPE, "application/bil16");
        ...
        // Int32 default type
        setConfiguration(AUS_DEM, BandstifConfig.DEFAULT_DATA_TYPE, "application/bil32");
        bytes = getStandardRequest("application/bil");
    ...
    public void testByteOrder() throws Exception {
        ...
        setConfiguration(AUS_DEM, BandstifConfig.BYTE_ORDER, ByteOrder.BIG_ENDIAN.toString());
        ...
        setConfiguration(AUS_DEM, BandstifConfig.BYTE_ORDER, ByteOrder.LITTLE_ENDIAN.toString());
    ...
    public void testNoDataTranslation() throws Exception {
        ...
        setConfiguration(SF_DEM, BandstifConfig.NO_DATA_OUTPUT, String.valueOf(outNoData));
    ...
    protected void copySchemaFile(String file) throws IOException {
        File f = new File("../../web/app/src//webapp/schemas/" + file);
